# TaskME — สรุปงานค้าง & Handoff (ภาพรวมโปรเจกต์)

> **หมายเหตุ:** สำหรับ handoff เชิงเทคนิค/สถาปัตยกรรม/วิธี deploy ล่าสุด ให้อ่าน `CLAUDE.md` ที่ root เป็นหลัก
> เอกสารนี้เก็บไว้เป็นภูมิหลัง/แผนระยะยาว · เนื้อหาบางส่วนด้านล่าง (ข้อ 2, 4, 6) เป็นสถานะเก่า 31 ก.ค. ที่ทำเสร็จไปแล้ว
